...
export VERIFIER_CHAIN_URL=https://eth-goerli.g.alchemy.com/v2/${alchemy_key} # chain url where the verifier contract deployed, Note: please use your own secret key here
export VERIFIER_CONTRACT_ADDRESS=0xacd47ec395668320770e7183b9ee817f4ff8774e # verifier contract address
export VERIFIER_ACCOUNT=${wallet_key} # your goerli account private key
